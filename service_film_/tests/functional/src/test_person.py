...
@pytest.mark.anyio
async def test_positive_person_by_id(
    ...
    assert data_response.get('uuid') == expected_answer.get('full_return').get('id')
...
@pytest.mark.anyio
async def test_negative_person_by_id(
    make_get_request: Coroutine,
    es_write_data: Coroutine,
    query_data: Dict[str, Union[str, int, float, None]],
    expected_answer: Dict[str, Union[str, int, float, None]],
...
@pytest.mark.anyio
async def test_positive_films_by_person_id(
    make_get_request: Coroutine,
    es_write_data: Coroutine,
    set_get_cache,
    query_data: Dict[str, Union[str, int, float, None]],
...
@pytest.mark.anyio
async def test_negative_films_by_person_id(
    make_get_request: Coroutine,
    es_write_data: Coroutine,
    query_data: Dict[str, Union[str, int, float, None]],
    expected_answer: Dict[str, Union[str, int, float, None]],
